                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      className={`w-full px-4 py-3 pr-12 bg-white dark:bg-transparent border-2 rounded-lg text-primary-700 dark:text-white placeholder-primary-700/60 dark:placeholder-white/60 focus:outline-none focus:ring-2 transition-colors ${
                        errors.password 
                          ? 'border-red-500 focus:ring-red-500' 
                          : 'border-primary-700 dark:border-white focus:ring-primary-700 dark:focus:ring-white'
                      }`}
